...
class Addreminder extends StatefulWidget {
  Reminder? tasks;Addreminder({this.tasks});
...
class _AddreminderState extends State<Addreminder> {
  ...
  DateTime? dateTime;
  Reminder task = Reminder.empty();
  Remindercurdmap _map = Remindercurdmap();

  String title = "Add Reminder";
  void FormData() {
  ...
  void addtask() async {
    try {
      ...
      Reminder data = await _map.add(task);
      task.ReminderId = data.ReminderId;
      showmessage('Reminder added successful');
      setState(() {});
    } catch (error) {
      print(error);
      showmessage('Error Saving Reminder');
    }
  }
